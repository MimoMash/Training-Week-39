...
for (let i = 0; i < tall.length; i++) {
    sumTaskA = sumTaskA + tall[i];
}

console.log(sumTaskA);

// I did the loop above this way because i had trouble with initializing sum, since it's written as const in task below and we were told to not change code unless told so.
